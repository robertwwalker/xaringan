...
library(patchwork)
ggplot(UCBTab) +aes(x = Gender, fill = Admit) + geom_bar(color="darkgreen", position = "dodge") + scale_xaringan_fill_discrete() + theme_xaringan() + labs(x="") + ggplot(UCBTab) +aes(x = Gender, fill = Admit) + geom_bar(color="darkgreen", position = "fill") + scale_xaringan_fill_discrete() + theme_xaringan() + guides(fill="none") + labs(y="Proportion", x="")
```
]
